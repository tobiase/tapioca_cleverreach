...
setup(
    name='tapioca-cleverreach',
    version=get_version(package),
    description='CleverReach API wrapper using tapioca',
    long_description=readme,
    author=get_author(package),
    author_email=get_email(package),
    url='https://github.com/tobiase/tapioca-cleverreach',
    packages=[
        'tapioca_cleverreach',
    ],
    package_dir={'tapioca_cleverreach': 'tapioca_cleverreach'},
    include_package_data=True,
    install_requires=requirements,
    license="MIT",
    zip_safe=False,
    keywords='cleverreach',
    classifiers=[
